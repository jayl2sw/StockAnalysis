...
def get_price(code):
    ...
    df1 = pd.DataFrame({"Code": [s_code], "Price": [s_price], "Highest_90": [s_highest], "Lowest_90": [s_lowest]})
    print(df1)
    return df1
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        super().__init__()
        # 윈도우 설정
        self.setGeometry(1500, 200, 800, 120)  # x, y, w, h
        self.setWindowTitle('주식분석기 ver1')
